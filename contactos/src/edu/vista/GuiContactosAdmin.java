...
public class GuiContactosAdmin extends JFrame {
	private String codigo;
	private JPanel contentPane;
	private Contacto objContacto;

	public GuiContactosAdmin(String codigo,Contacto objContacto) {
		this.codigo=codigo;
		...
		btnAdministradores.setBounds(72, 197, 130, 23);
		...
		btnDocentes.setBounds(212, 197, 130, 23);
		...
		btnEstudiantes.setBounds(352, 197, 130, 23);
		...
		lblImgadmin.setBounds(72, 58, 130, 128);
		...
		lblimgDocente.setBounds(212, 58, 130, 128);
		...
		lblImgEstudiante.setBounds(352, 58, 130, 128);
